...
namespace CoffeeShop.Presenter
{
    public class PlaceOrderPresenter
    {
        ...
        private void PayEvent(object sender, EventArgs e)
        {
            ...
            new PaymentPresenter(paymentView, repository);
            ...
            if (paymentView.IsOpen)
            {
                ...
                invoiceView.lbInvoiceID.Text = paymentView.InvoiceID;
                invoiceView.lbPeople.Text = view.NumberPeople.ToString();
                invoiceView.lbDate.Text = saleDate.ToString("MM/dd/yyyy");
                ...
                invoiceView.lb.Visible = true;
                invoiceView.lbPayment.Visible = true;
                invoiceView.lbPayment.Text = paymentView.PaymentMethod;
                invoiceView.btnPrint.Text = "Pay";
                ...
                invoiceView.lbTotal.Text = totalSum.ToString("N0");
                ...
                invoiceView.btnPrint.Click += delegate
                {
                    ...
                    try
                    {
                        ...
                        {
                            InvoiceID = paymentView.InvoiceID,
                            CustomerID = paymentView.CustomerID,
                            PaymentID = paymentView.PaymentMethod == "Cash" ? "01" : "02",
                            SaleDate = saleDate,
                            OrderID = view.OrderID
                        };

                        repository.AddInvoice(invoice);
                        repository.UpdateTableStatus(view.TableNo, AppConst.TABLE_AVAILABLE);
                        repository.UpdateOrderStatus(view.OrderID, AppConst.ORDER_STATUS_DONE);

                        invoiceView.Close();
                        DialogMessageView.ShowMessage("success", $"Invoice ID {paymentView.InvoiceID} Pay Success!");
                    ...
                    {
                        DialogMessageView.ShowMessage("warning", "An error occur! Can't pay");
                    }
                };
            }
        }
        ...
        {          
            ...
            invoiceView.lbStaff.Text = view.StaffName.ToString();             
            invoiceView.lbOrderID.Text = view.OrderID.ToString();
            invoiceView.lb.Visible = false;
            invoiceView.lbPayment.Visible = false;
        ...
        private void CompleteOrderEvent(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!view.IsEdit)
                {
                    ...
                    repository.UpdateOrderStatus(view.OrderID, AppConst.ORDER_STATUS_PENDING);
                }
                else
                {
